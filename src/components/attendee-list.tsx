        ...
        <div className="flex flex-col gap-4">
            <div className="flex gap-3 items-center">
                ...
                <div className="px-3 w-72 py-1.5 border border-white/10 bg-transparent rounded-lg flex items-center gap-3">
                    ...
                    <input className="bg-transparent flex-1 outline-none border-0 p-0 text-sm" placeholder="Search for participant..." />
                </div>
            </div>
                        ...
                        {Array.from({ length: 8 }).map((_, i) => {
                            return (
                                <tr key={i} className="border-b border-white/10 hover:bg-white/5">
                                    ...
                                    <td className="py-3 px-4 text-sm text-left text-zinc-300">12134</td>
                                    <td className="py-3 px-4 text-sm text-left text-zinc-300">
                                        <div className="flex flex-col gap-1">
                                            <span className="font-semibold text-white">João Vitor Figueiredo Espindola</span>
                                            <span>joaovitorfespindola@gmail.com</span>
                                        </div>
                                    </td>
